...
import com.atguan.scw.enums.ProjectStatusEnume;
...
import com.atguan.scw.project.vo.req.BaseVo;
import com.atguan.scw.project.vo.req.ProjectBaseVo;
import com.atguan.scw.project.vo.req.ProjectRedisStorageVo;
import com.atguan.scw.project.vo.req.ProjectReturnVo;
...
public class ProjectCreateController {
	...
	public AppResponse<Object> init(BaseVo vo) {
		...
		try {
			...
			if(StringUtils.isEmpty(accessToken)) {
				...
				resp.setMsg("请求必须提供assessTok                                                                                                                                                           en值");
				return resp;
			}
	...
	public AppResponse<Object> baseinfo(ProjectBaseVo vo) {
